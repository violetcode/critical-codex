...
urlpatterns += patterns('',
	...
	url(r'^upgrade/$', views.stripe_form, name='Upgrade'),
	url(r'^upgrade/success/$', views.stripe_success, name='Upgrade_Success'),
    url(r'^account/$', views.EditAccount, name='AccountSettings'),
    url(r'^account/profile/$', views.EditProfile, name='ProfileSettings'),
    url(r'^account/premium/$', views.EditPremium, name='PremiumSettings'),
    url(r'^account/cancel_premium/$', views.CancelPremium, name='cancel-premium'),
    url(r'^account/confirm_deactivation/$', views.deactivate_account, name='AccountDeactivate'),
    url(r'^account/confirm_reactivation/$', views.reactivate_account, name='AccountReactivate'),
